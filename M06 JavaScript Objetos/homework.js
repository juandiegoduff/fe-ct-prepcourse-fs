...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   if (objetoMisterioso.hasOwnProperty("numeroMisterioso")) {
      // Multiplica el valor de la propiedad por 5 y devuelve el resultado
      return objetoMisterioso.numeroMisterioso * 5;
   } else {
      // Manejo de caso en el que la propiedad no existe
      return "La propiedad 'numeroMisterioso' no está definida en el objeto.";
   }
}
...
function eliminarPropiedad(objeto, propiedad) {
   ...
   if (objeto.hasOwnProperty(propiedad)) {
      // Utiliza el operador delete para eliminar la propiedad
